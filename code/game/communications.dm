...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_TWITCH = FREQ_TWITCH,
	RADIO_CHANNEL_DISCORD = FREQ_DISCORD,
	RADIO_CHANNEL_YOUTUBE = FREQ_YOUTUBE,
))
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_TWITCH]" = RADIO_CHANNEL_TWITCH,
	"[FREQ_DISCORD]" = RADIO_CHANNEL_DISCORD,
	"[FREQ_YOUTUBE]" = RADIO_CHANNEL_YOUTUBE,
))
